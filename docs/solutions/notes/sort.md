...
[Solve in editor →](https://icfpcontest2026.com/problems/sort-numbers/editor)
...
A test case contains multiple [rounds](https://icfpcontest2026.com/grading#round-based), each of which contains a single list. Lists may vary in length between rounds. You won't receive the next list until you finish printing the current one.
