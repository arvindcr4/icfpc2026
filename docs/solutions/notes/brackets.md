...
[Solve in editor →](https://icfpcontest2026.com/problems/brackets/editor)

**Scoring: footprint-tick.** See [scoring](https://icfpcontest2026.com/grading#program-scoring) and [ascii](https://icfpcontest2026.com/grading#ascii) for help.

Read a string of bracket characters and report whether it is balanced.

Each input is one length-prefixed string: a count `n`, then `n` bytes, each the decimal [ASCII](https://icfpcontest2026.com/grading#ascii) code of one character drawn from `( ) [ ] { }`.
