PROBLEM ID IS f66c928f-3369-4870-9153-8b20cafc2ecd
...
**This is an [uber-strict](https://icfpcontest2026.com/grading#uber-strict) problem.** It is evaluated against an extra hidden test corpus.
...
Each [round](https://icfpcontest2026.com/grading#round-based) delivers three integers `r c v` describing the contents of one cell. `r` and `c` are the 0-indexed row and column of the cell, and `v` is the value (between 1 and 9) placed at that cell.
...
**violation on final cell** Round 1
